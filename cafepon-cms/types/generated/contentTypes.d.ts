...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    eventButtonText: Schema.Attribute.String;
    eventUrl: Schema.Attribute.String;
    isLimitedTimeActive: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    isSpecialEvent: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    limitedTimeEndDate: Schema.Attribute.DateTime;
    limitedTimeStartDate: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
